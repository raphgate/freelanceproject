...
?>
    ...
    $chat_id = $_SESSION['chat_id'];
     $chatquery=mysqli_query($con, "SELECT * FROM messagebox WHERE project_id='".$project_id."' AND sender_id='".$user_id."' AND id > '".$chat_id."' OR receive_id='".$user_id."' AND project_id='".$project_id."' AND id >'".$chat_id."'  GROUP BY id ASC");

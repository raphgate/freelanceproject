 ...
 <table class="table table-hover">
                <thead>
                    ...
                    <th><i class="fa fa-bookmark fa-2x"></i></th>
                                    ...
                                    $myskillsquery=mysqli_query($con, "SELECT * FROM projects WHERE projectName LIKE '%$name%' OR skillRequired LIKE '%$skill%' ORDER BY id DESC LIMIT $start_from, $record_per_page ");

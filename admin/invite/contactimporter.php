...
<head id="Head1">
    ...
    <script type="text/javascript">
        ...
        var changeService = function () {
            if (document.getElementById("ddnservice").value == "csv") {
                $(".outlook").show();
                $(".nonoutlook").hide();
            }
            else {
...
<body>
            <?php
                ...
                $RedirectUrl = 'http://localhost/socialinviter-source/REST/php/contactimporter.php';
                $service = 'gmail';
                $token='';
                $tokensecret = '';
                $tokenverifier = '';
               ...
               else if($_SERVER['REQUEST_METHOD']=='POST')
               {
                    if($_POST['reqtype']=='getauthurl'){
                        ...
                        $authRequestUrl = "https://socialinviter.com/api/contacts.aspx?";
                        ...
                        //GET ACCESS TOKEN
                        $accessRequestUrl = "https://socialinviter.com/api/contacts.aspx?";
                        ...
                        //GET CONTACTS
                        $conRequestUrl = "https://socialinviter.com/api/contacts.aspx?";
            ...
            ?>
            <form method="POST" action="contactimporter.php">

                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseTwo" class="panel-collapse collapse in">
                                                <div class="panel-body">
                                                 ...
                                                 <!--  -->
                                                        <div class="col-md-12">
                                                          <form id='' action="" method="POST" enctype="multipart/form-data" class="panel role" style="width: 80%;margin-left: 10%;margin-top: 5%">
                                                            <script src="https://js.paystack.co/v1/inline.js"></script>
                                                              <center><label>Plan Amount</label><br>
                                                             <div class="form-group">
                                                              <select type="number" id="amount" class="form-control">

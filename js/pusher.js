 ...
 ! function(t, e) {
    ...
    return function(t) {
            ...
            return function i(t, o) {
                ...
                switch (typeof t) {
                    case "object":
                        ...
                        if (e.push(t), n.push(o), "[object Array]" === Object.prototype.toString.apply(t))
                            for (a = [], r = 0; r < t.length; r += 1) a[r] = i(t[r], o + "[" + r + "]");
                        else {
                            a = {};
                            for (s in t) Object.prototype.hasOwnProperty.call(t, s) && (a[s] = i(t[s], o + "[" + JSON.stringify(s) + "]"))
                        }
                        return a;
                    case "number":
                    case "string":
        ...
        var u = n(34),
            ...
            f = function() {
                function t(t, e) {
                    this.hooks = t, this.session = a(1e3) + "/" + c(8),
                        this.location = i(e), this.readyState = u["default"].CONNECTING, this.openStream()
                }
                return t.prototype.send = function(t) {
